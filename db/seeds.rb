...
User.create(first_name: "Leslie", last_name: "Knope", email: "lara@gmail.com", zipcode: "11217", profile_picture: "http://38.media.tumblr.com/avatar_c964046726bd_128.png", favorite_games: "Basketball, Football, Tennis", host: false, provider: "facebook", uid: nil, token: nil, expires_at: nil, expires: true)
